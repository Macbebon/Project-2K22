...
{
var contact = document.getElementById("staff_mobile").value;
  var phoneno = /^\d{10}$/;
...
<?php include 'header.php'; ?>
        ...
        <div class='content_addstaff'>
            ...
            <div class='addstaff'>
        <form action="add_staff.php" method="POST" name = "myform" >
             <table align='center'>
                ...
                <tr>
                    <td>Mobile</td>
                    <td><input type="text" name="staff_mobile" id = "staff_mobile" required="" onblur="phonenumber()"/></td>
                </tr>
