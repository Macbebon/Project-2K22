   ...
   text-align: center;
        ...
        <div class='content'>
           <?php include 'staff_navbar.php'?>
            ...
            $old=  mysqli_real_escape_string($cid,$_REQUEST['old_password']);
            $new=  mysqli_real_escape_string($cid,$_REQUEST['new_password']);
            $again=  mysqli_real_escape_string($cid,$_REQUEST['again_password']);
